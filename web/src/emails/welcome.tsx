...
export const WelcomeEmail = ({ name }: WelcomeEmailProps) => (
	<Html lang="is">
		<Head />
		<Preview>Velkomin til Órslofs! Þú hefur skráð þig inn með öruggum hætti.</Preview>
		<Body style={main}>
			<Container style={container}>
				<Section style={box}>
					...
					<Text style={text}>
						Velkomin til Órslofs! Þú hefur skráð þig inn með öruggum hætti með Kenni rafrænum
						skilríkjum.
					</Text>
					...
					<Section style={list}>
						...
						<Text style={listItem}>• Hafð samband við okkur ef þú þarft aðstoð</Text>
					</Section>
